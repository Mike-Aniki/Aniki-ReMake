...
|------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|------------------------------------------------------------------|
| [Add-ons for the theme](#please-follow-these-instructions-before-using-a-theme) | [Modify Status on Game Cover](#modify-status-on-game-cover)                         | [Setting for Logos](#for-logos)                                  |
